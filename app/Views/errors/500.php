...
<html lang="en" data-layout="vertical" data-topbar="light" data-sidebar="dark" data-sidebar-size="lg" data-sidebar-image="none" data-preloader="disable">
	<head>
		<meta charset="utf-8">
		<title>500 Error| vip2cars</title>
		<meta name="viewport" content="width=device-width, initial-scale=1.0">
		<meta content="Premium Multipurpose Admin & Dashboard Template" name="description">
		<meta content="Themesbrand" name="author">
		<!-- App favicon -->
		<link rel="shortcut icon" href="<?= base_url() ?>/public/images/logo-Iris Visión-sm.png">
		<!-- Layout config Js -->
					...
					<div class="row justify-content-center">
						<div class="col-xl-4 text-center">
							<div class="error-500 position-relative">
								<img src="<?= base_url() ?>/public/images/error500.png" alt="" class="img-fluid error-500-img error-img">
							...
							<div>
								...
								<a href="<?= base_url() ?>/iniciar-sesion" class="btn btn-success">
									<i class="mdi mdi-home me-1"></i>Iniciar sesión
								</a>
							</div>
						</div>
						<!-- end col-->
