									...
									<div class="col-lg-12">
										<div class="p-lg-5 p-4">
											<div class="mx-auto text-center">
												<img src="<?= $baseUrl ?>/public/images/logo.png" alt="cambiazo.pe" width="250">
											</div>
											<div class="mt-5">
												<form class="formulario" action="<?= $baseUrl ?>/grabar-cuenta" method="POST">
													<span class="respuesta"></span>
													<div class="mb-3">
														<label for="username" class="form-label">Nombres</label>
														<input type="text" class="form-control form-control-lg rounded-4" id="nombres" name="nombres" placeholder="Ingresa tus nombres">
													</div>
													<div class="mb-3">
														<label for="username" class="form-label">Apellidos</label>
														<input type="text" class="form-control form-control-lg rounded-4" id="apellidos" name="apellidos" placeholder="Ingresa tus apellidos">
													</div>
													<div class="mb-3">
													...
													<div class="mb-3">
														<div class="form-check">
															<input class="form-check-input" type="checkbox" id="terminos_condiciones" name="terminos_condiciones" required>
															<label class="form-check-label" for="terminos_condiciones">
																He leído y acepto los <a href="#" class="text-decoration-underline">Términos y condiciones</a>
															</label>
														</div>
													</div>
													...
													<div class="mb-3">
														<div class="form-check">
															...
															<label class="form-check-label" for="politica_privacidad">
																Acepto de manera expresa e informada la <a href="#" class="text-decoration-underline">Política de Privacidad</a>
															</label>
														</div>
													</div>
													
													<div class="mt-4">
														<button class="btn btn-primary btn-lg w-100 rounded-4" type="submit">Crear cuenta</button>
													</div>
													<div class="mt-3 text-center">
														<a href="<?= $baseUrl ?>/iniciar-sesion">¿Ya tienes una cuenta? Ingresa aquí</a>
													</div>
												</form>
											</div>
										</div>
