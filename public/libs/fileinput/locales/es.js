...
$.fn.fileinputLocales['es'] = {
    ...
    "msgFilesTooMany": "El número de archivos seleccionados a cargar <b>({n})<\/b> excede el lí­mite máximo permitido de <b>{m}<\/b>.",
    ...
    "msgFilePreviewError": "Ocurrió un error mientras se leí­a el archivo \"{name}\".",
    ...
    "msgUploadEnd": "Hecho",
    "msgUploadEmpty": "No existen datos válidos para el enví­o.",
    ...
    "msgAjaxError": "Algo ha ido mal con la operación {operation}. Por favor, intí©ntelo de nuevo mas tarde.",
    ...
    "fileActionSettings": {
        ...
        "indicatorNewTitle": "No subido todaví­a",
